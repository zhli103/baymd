...
package com.zhli.baymd.ingestion.service.impl;
...
import com.zhli.baymd.rag.controller.request.DocumentSourceRequest;
import com.zhli.baymd.ingestion.controller.request.IngestionTaskCreateRequest;
import com.zhli.baymd.ingestion.controller.vo.IngestionTaskNodeVO;
import com.zhli.baymd.ingestion.controller.vo.IngestionTaskVO;
import com.zhli.baymd.ingestion.dao.entity.IngestionTaskDO;
import com.zhli.baymd.ingestion.dao.entity.IngestionTaskNodeDO;
import com.zhli.baymd.ingestion.dao.mapper.IngestionTaskMapper;
import com.zhli.baymd.ingestion.dao.mapper.IngestionTaskNodeMapper;
import com.zhli.baymd.framework.context.UserContext;
import com.zhli.baymd.framework.exception.ClientException;
import com.zhli.baymd.ingestion.domain.context.DocumentSource;
import com.zhli.baymd.ingestion.domain.context.IngestionContext;
import com.zhli.baymd.ingestion.domain.context.NodeLog;
import com.zhli.baymd.ingestion.domain.enums.IngestionNodeType;
import com.zhli.baymd.ingestion.domain.enums.IngestionStatus;
import com.zhli.baymd.ingestion.domain.enums.SourceType;
import com.zhli.baymd.ingestion.domain.pipeline.NodeConfig;
import com.zhli.baymd.ingestion.domain.pipeline.PipelineDefinition;
import com.zhli.baymd.ingestion.domain.result.IngestionResult;
import com.zhli.baymd.ingestion.engine.IngestionEngine;
import com.zhli.baymd.ingestion.util.MimeTypeDetector;
import com.zhli.baymd.rag.core.vector.VectorSpaceId;
import com.zhli.baymd.ingestion.service.IngestionPipelineService;
import com.zhli.baymd.ingestion.service.IngestionTaskService;
