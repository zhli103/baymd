...
package com.zhli.baymd.knowledge.service.impl;
...
import com.zhli.baymd.core.chunk.ChunkEmbeddingService;
...
import com.zhli.baymd.ingestion.dao.entity.IngestionPipelineDO;
import com.zhli.baymd.ingestion.dao.mapper.IngestionPipelineMapper;
import com.zhli.baymd.ingestion.domain.context.IngestionContext;
import com.zhli.baymd.ingestion.domain.pipeline.PipelineDefinition;
import com.zhli.baymd.ingestion.engine.IngestionEngine;
import com.zhli.baymd.ingestion.service.IngestionPipelineService;
import com.zhli.baymd.knowledge.config.KnowledgeScheduleProperties;
import com.zhli.baymd.knowledge.controller.request.KnowledgeChunkCreateRequest;
import com.zhli.baymd.knowledge.controller.request.KnowledgeDocumentPageRequest;
import com.zhli.baymd.knowledge.controller.request.KnowledgeDocumentUpdateRequest;
import com.zhli.baymd.knowledge.controller.request.KnowledgeDocumentUploadRequest;
import com.zhli.baymd.knowledge.controller.vo.KnowledgeChunkVO;
import com.zhli.baymd.knowledge.controller.vo.KnowledgeDocumentChunkLogVO;
import com.zhli.baymd.knowledge.controller.vo.KnowledgeDocumentSearchVO;
import com.zhli.baymd.knowledge.controller.vo.KnowledgeDocumentVO;
import com.zhli.baymd.knowledge.dao.entity.KnowledgeBaseDO;
import com.zhli.baymd.knowledge.dao.entity.KnowledgeDocumentChunkLogDO;
...
import com.zhli.baymd.knowledge.dao.mapper.KnowledgeDocumentChunkLogMapper;
import com.zhli.baymd.knowledge.dao.mapper.KnowledgeDocumentMapper;
import com.zhli.baymd.knowledge.enums.DocumentStatus;
import com.zhli.baymd.knowledge.enums.ProcessMode;
import com.zhli.baymd.knowledge.enums.SourceType;
import com.zhli.baymd.knowledge.handler.RemoteFileFetcher;
import com.zhli.baymd.knowledge.mq.event.KnowledgeDocumentChunkEvent;
import com.zhli.baymd.knowledge.schedule.CronScheduleHelper;
import com.zhli.baymd.knowledge.service.KnowledgeChunkService;
import com.zhli.baymd.knowledge.service.KnowledgeDocumentScheduleService;
import com.zhli.baymd.knowledge.service.KnowledgeDocumentService;
import com.zhli.baymd.rag.core.vector.VectorSpaceId;
import com.zhli.baymd.rag.core.vector.VectorStoreService;
