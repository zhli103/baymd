...
import com.zhli.baymd.rag.service.bo.ConversationSummaryBO;
...
import static com.zhli.baymd.rag.constant.RAGConstant.CONVERSATION_SUMMARY_PROMPT_PATH;
...
public class JdbcConversationMemorySummaryService implements ConversationMemorySummaryService {
    ...
    private static final String SUMMARY_LOCK_PREFIX = "baymd:memory:summary:lock:";
